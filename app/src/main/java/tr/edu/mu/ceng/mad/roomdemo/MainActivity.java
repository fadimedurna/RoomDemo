...
public class MainActivity extends AppCompatActivity implements
        DepartmentFragment.DepartmentListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = Room.databaseBuilder(this,UniversityDB.class,"university")
                 .build();
        new Thread(){
            public void run(){
            ...
            public void run(){
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ft.replace(R.id.container,EditDepartmentFragment.newInstance
                                (selectedDepartment, courses),"edit_department");
